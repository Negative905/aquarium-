        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          >
            <motion.li variants={navLinkItem}>
              <motion.a href="/" className="hover:opacity-70 transition-opacity font-medium whitespace-nowrap" whileHover={{ y: -1 }}>
                Home
              </motion.a>
            </motion.li>

            <motion.li variants={navLinkItem}>
              <motion.a href="/about" className="hover:opacity-70 transition-opacity font-medium whitespace-nowrap" whileHover={{ y: -1 }}>
                About us
              </motion.a>
            </motion.li>
            ...
            <motion.li variants={navLinkItem}>
              <motion.a href="/services" className="hover:opacity-70 transition-opacity font-medium whitespace-nowrap" whileHover={{ y: -1 }}>
                Services
              </motion.a>
            </motion.li>
            <motion.li variants={navLinkItem}>
              <motion.a href="/contact" className="hover:opacity-70 transition-opacity font-medium whitespace-nowrap" whileHover={{ y: -1 }}>
                Contact
              </motion.a>
            </motion.li>
          </motion.ul>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden lg:flex items-center gap-2">
              ...
              <motion.button
                ...
                variants={iconButtonVariant} initial="hidden" animate="visible" custom={0}
            ...
            {/* Mobile: cart + login icons always visible */}
          ...
          {isMenuOpen && (
            ...
            >
              <ul className="flex flex-col mt-3 text-black text-sm divide-y divide-black/5">
                ...
                {[{ label: 'Home', href: '/' }, { label: 'About us', href: '/about' }, { label: 'Services', href: '/services' }, { label: 'Contact', href: '/contact' }].map(({ label, href }) => (
                  <li key={label}>
                    <a href={href} className="block py-3 font-medium hover:opacity-70 transition-opacity" onClick={() => setIsMenuOpen(false)}>
                      {label}
                    </a>
                  </li>
                ))}
                ...
                <li>
                  ...
                  >
                    Aquariums
                    <motion.svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}
                  ...
                  <AnimatePresence>
                    {mobileAquariumsOpen && (
                      <motion.ul initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.25 }}
                        className="overflow-hidden pl-4 pb-2 space-y-2">
                        {aquariumSubs.map(({ label, href }) => (
                          <li key={label}><a href={href} className="block text-sm text-gray-700 hover:opacity-70 py-1" onClick={() => setIsMenuOpen(false)}>{label}</a></li>
                        ))}
                      </motion.ul>
                    )}
                  </AnimatePresence>
