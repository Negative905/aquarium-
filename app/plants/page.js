...
const products = [
  {
    id: 1,
    name: 'Anubias',
    description: 'Low maitainance plant perfect for beginners.',
    price: '₹300 – ₹900',
    image: '/plant1.png',
    alt: 'Betta Fish',
  },
  {
    id: 2,
    name: 'Java Fern',
    description: 'Hardy and elegant plant for freshwater tanks.',
    price: '₹250 – ₹800',
    image: '/plant2.png',
    alt: 'Angelfish',
  },
  {
    id: 3,
    name: 'Amazon Sword',
    description: 'Board-Lead beauty ideal for background decor',
    price: '₹400 – ₹1,200',
    image: '/plant3.png',
    alt: 'Guppy',
  },
  {
    id: 4,
    name: 'Dward Hairgrass',
    description: 'Creates a lush green carpet effect.',
    price: '₹5,00 – ₹1,500',
    image: '/plant4.png',
    alt: 'Goldfish',
  },
