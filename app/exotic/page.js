...
const products = [
  {
    id: 1,
    name: 'Seahorse',
    description: 'A graceful and unique marine marvel.',
    price: '₹4,000 – ₹10,000',
    image: '/fish9.png',
    alt: 'Betta Fish',
  },
  {
    id: 2,
    name: 'Starfish',
    description: 'Natural beauty resting on the ocean floor.',
    price: '₹2,000 – ₹6,000',
    image: '/fish10.png',
    alt: 'Angelfish',
  },
  {
    id: 3,
    name: 'Cleaner Shrimp',
    description: 'Functional elegance that supports tank health',
    price: '₹1,500 – ₹3,500',
    image: '/fish11.png',
    alt: 'Guppy',
  },
  {
    ...
    description: 'A rare and captivating showpiece species.',
    price: '₹15,000 – ₹50,000',
    image: '/fish12.png',
    alt: 'Goldfish',
  },
