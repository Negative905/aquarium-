...
export default function AboutPage() {
  ...
  return (
  <div className="min-h-screen bg-[linear-gradient(180.8deg,#065EB6_0.68%,#000C18_99.32%,#E3FDFD_99.32%)]">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <ul className="hidden md:flex items-center gap-6 lg:gap-8 text-sm text-[#b0c4d8]">
              ...
              >
                ...
                {isAquariumsOpen && (
  <div className="absolute top-full left-0 bg-white shadow-lg rounded-sm z-50" style={{ minWidth: '130px', paddingTop: '4px' }}>
    <div className="overflow-hidden rounded-sm">
      <a href="fresh" className="block px-4 py-2.5 text-black text-sm hover:bg-gray-50 transition-colors border-b border-gray-100">Freshwater</a>
