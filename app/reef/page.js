...
const products = [
  {
    id: 1,
    name: 'Coral Reef Nano Tank',
    description: 'Small reef tank ideal for beginners.',
    price: '₹45,000 – ₹80,000',
    image: '/reef1.png',
    alt: 'kgf',
  },
  {
    id: 2,
    name: 'Advanced Reef System',
    description: 'Professional reef setup with sump filteration.',
  ...
  {
    id: 3,
    name: 'SPS Coral Display',
    description: 'Hight-light reef tank for vibrant sps corals',
  ...
  {
    id: 4,
    name: 'LPS Reef Aquarium',
    description: 'Balanced reef system for large-polyp corals',
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <ul className="hidden md:flex items-center gap-6 lg:gap-8 text-sm text-[#b0c4d8]">
              ...
              >
                <a href="#" className="text-white font-medium flex items-center gap-1">
                  Aquariums
                  <svg
                ...
                {isAquariumsOpen && (
                  <div className="absolute top-full left-0 mt-1 bg-white shadow-lg rounded-sm overflow-hidden z-50 min-w-[130px]">
              ...
              <li><a href="#" className="hover:text-white transition-colors font-medium">Fish & Species</a></li>
