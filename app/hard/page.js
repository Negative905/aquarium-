...
const products = [
  { id: 601, name: 'Acropora (SPS)', description: 'Highlight coral for vibrant reef tanks.', price: '₹3,000 – ₹8,000', numericPrice: 5500, image: '/coral5.png', alt: 'Acropora', size: 'Standard', color: 'Varies' },
  { id: 602, name: 'Brain Coral', description: 'Intricate patterns with bold presence.', price: '₹4,000 – ₹10,000', numericPrice: 7000, image: '/coral6.png', alt: 'Brain Coral', size: 'Standard', color: 'Varies' },
  { id: 603, name: 'Hammer Coral', description: 'Elegant coral with flowing tentacles', price: '₹3,500 – ₹8,000', numericPrice: 5750, image: '/coral7.png', alt: 'Hammer Coral', size: 'Standard', color: 'Varies' },
  { id: 604, name: 'Torch Coral', description: 'Striking centerpiece coral with vivid glow.', price: '₹4,000 – ₹12,000', numericPrice: 8000, image: '/coral8.png', alt: 'Torch Coral', size: 'Standard', color: 'Orange' },
]
...
export default function HardCoralsPage() {
  const [quantities, setQuantities] = useState({})
  const [sortBy, setSortBy] = useState('')
  const [isSortOpen, setIsSortOpen] = useState(false)

  const handleAddToCart = (product) => {
    addToCart({ ...product, source: 'hard-corals', quantity: 1 })
  ...
  const handleIncrease = (product) => {
    ...
    addToCart({ ...product, source: 'hard-corals', quantity: newQty })
  }
    ...
    <div className="min-h-screen bg-[linear-gradient(180.8deg,#065EB6_0.68%,#000C18_99.32%)]">
      <div className="pt-16">
        ...
        <section className="py-10 text-center px-4">
          ...
          <p className="text-[#8fa8c0] text-sm sm:text-base tracking-wide">Hard Corals</p>
        </section>
