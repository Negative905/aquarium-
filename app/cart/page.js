...
const PROMO_CODES = {
  OCEAN10: { discount: 0.1, label: "10% off", description: "Welcome offer" },
  AQUA20: { discount: 0.2, label: "20% off", description: "Aqua lovers deal" },
  CROWN15: {
    discount: 0.15,
    label: "15% off",
    description: "Crown member discount",
  },
...
export default function CartPage() {
  ...
  const handleApplyPromo = () => {
    ...
    if (PROMO_CODES[code]) {
      ...
      setPromoError("");
      setPromoSuccess(
        `"${code}" applied — ${PROMO_CODES[code].label} extra discount!`,
      );
    } else {
  ...
  const promoDiscount = appliedPromo
    ? Math.round(afterDiscount * appliedPromo.discount)
    : 0;
  const total =
    afterDiscount - promoDiscount + (items.length > 0 ? DELIVERY_FEE : 0);
          ...
          {items.length === 0 ? (
            ...
            >
              ...
              <p className="text-blue-300 text-sm">
                Browse our aquariums, fish, plants & corals to add items!
              </p>
                        ...
                        <div className="p-5 flex items-center gap-5">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex justify-between items-start">
                              ...
                              <motion.button
                                onClick={() =>
                                  handleRemove(item.id, item.source)
                                }
                            ...
                            <div className="flex justify-between items-center mt-3">
                              ...
                              <div className="flex items-center gap-4 text-white text-base">
                                <motion.button
                                  onClick={() =>
                                    handleUpdateQty(item.id, item.source, -1)
                                  }
                    ...
                    {!appliedPromo ? (
                      ...
                      >
                        ...
                        <div className="mt-1 bg-white/10 rounded p-2.5">
                          <p className="text-white/60 text-xs mb-1.5 font-medium">
                            Available Promo Codes:
                          </p>
                          <div className="flex flex-col gap-1">
                            {Object.entries(PROMO_CODES).map(
                              ([code, info], i) => (
                                <motion.div
                                  key={code}
