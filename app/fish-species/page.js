...
const LOCAL_IMAGES = {
  ...
  Cichlid: "/fish8.png",
  "Clown Fish": "/freshwater-1.png",
  "Blue Tang": "/freshwater-2.png",
  "Butterfly Fish": "/freshwater-3.png",
  "Royal Gramma": "/freshwater-4.png",
  Seahorse: "/fish9.png",
  Starfish: "/fish10.png",
...
export default function FreshwaterFishPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        // ✅ Direct category ID — no lookup needed
        const res = await fetch(
          `${API}/products?categories=69b25001da5543e64646dd2e`,
        );
        ...
        console.error("Failed to fetch freshwater fish:", err);
      } finally {
        setLoading(false);
      }
    };
